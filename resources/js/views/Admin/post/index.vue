      ...
      <div class="relative bg-white-600 md:pt-8 pb-8 pt-12">
        <div class="px-4 md:px-10 mx-auto w-full">
          <div>
            ...
            <div class="flex flex-wrap mt-10" v-for="(question, index) in questions" :key="index">
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg border-4 border-gray-100">
                  <div class="flex-auto p-4">
                    ...
                    <div class="flex flex-row">
                      <i class="relative" v-for="(question_img, qimg) in question_imgs" :key="qimg">
                          <i class="border-none items-center justify-center w-full h-96 shadow-lg pt-10" v-if="question_img.question_id == question.id">
                            <a href="#" @click="showImage(question_img.id)" class="w-full h-full" v-if="question_img.name == 'jpeg' || question_img.name == 'jpg' || question_img.name == 'png' || question_img.name == 'JPEG' || question_img.name == 'JPG' || question_img.name == 'PNG'">
                              <img class="h-full w-full p-1" :src="'/career-clinic/public'+question_img.image" :alt="question_img.name">
                            </a>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <i class="hidden" v-for="(question_a, qaid) in question_associations" :key="qaid">
                        ...
                        <i class="hidden" v-for="(question_r, qid) in question_replies" :key="qid">
                        ...
                        <i class="hidden" v-for="(question_s, qsid) in question_shares" :key="qsid">
              ...
              <div v-for="(admin, adm) in admins" :key="adm">
                <div v-if="admin.id == currentUser.id && admin.user_type == currentUser.user_type">
                  <div v-if="question.id == commentShow.frame" v-bind:class="{ hidden: !commentShow.display, block: commentShow.display }">
                    <add-comment :user_id="admin.id" :user_category="admin.user_type" :question_id="question.id"></add-comment>
                    <comment-component :user_id="admin.id" :user_category="admin.user_type" :question_post_id="question.user_id" :question_post_cat="question.user_category" :question_id="question.id"></comment-component>
                  </div>
...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        association(id) { 
          axios.post('/career-clinic/api/createAssociation', this.associationData).then((response) => {
        ...
        share(id) { 
          axios.post('/career-clinic/api/createShare', this.shareData).then((response) => {
            //this.commentData.reply = ''
          }).catch((errors) => {
            console.log(errors)
          });
