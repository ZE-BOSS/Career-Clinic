<template>
    <div class="mt-0 pt-0">
        <div v-for="(question_reply, qr) in question_replies" :key="qr" class="mt-2 pt-0">
            <div v-if="question_reply.question_id == question_id" class="relative border-t-2 border-gray-250 ml-10 w-11/12 bg-white border mt-0 shadow-sm px-16 py-4 rounded-lg">
                ...
                <div class="flex flex-wrap text-gray-500">
                    ...
                    <i class="hidden" v-for="(question_r_c, qrid) in question_reply_comments" :key="qrid">
            ...
            <div v-for="(admin, add) in admins" :key="add">
                <div v-if="admin.id == currentUser.id && admin.user_type == currentUser.user_type">
                    <div v-if="question_reply.id == commentReplyShow.frame" v-bind:class="{ hidden: !commentReplyShow.display, block: commentReplyShow.display }">
                        <add-reply-comment-component :user_id="admin.id" :user_category="admin.user_type" :reply_id="question_reply.id"></add-reply-comment-component>
                        <reply-comment-component :user_id="admin.id" :user_category="admin.user_type" :reply_id="question_reply.id"></reply-comment-component>
                    </div>
